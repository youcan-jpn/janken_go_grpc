...
type RockPaperScissorsServiceClient interface {
	...
	ShowHistory(ctx context.Context, in *ShowRequest, opts ...grpc.CallOption) (*ShowResponse, error)
}
...
func (c *rockPaperScissorsServiceClient) ShowHistory(ctx context.Context, in *ShowRequest, opts ...grpc.CallOption) (*ShowResponse, error) {
	out := new(ShowResponse)
	err := c.cc.Invoke(ctx, "/game.RockPaperScissorsService/ShowHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RockPaperScissorsServiceServer interface {
	...
	ShowHistory(context.Context, *ShowRequest) (*ShowResponse, error)
}
...
func (UnimplementedRockPaperScissorsServiceServer) ShowHistory(context.Context, *ShowRequest) (*ShowResponse, error) {
...
func _RockPaperScissorsService_ShowHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ShowRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RockPaperScissorsServiceServer).ShowHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/game.RockPaperScissorsService/ShowHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RockPaperScissorsServiceServer).ShowHistory(ctx, req.(*ShowRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RockPaperScissorsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RockPaperScissorsService_ShowHistory_Handler,
		},
	},
